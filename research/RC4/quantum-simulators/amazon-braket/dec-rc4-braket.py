...
Using Amazon Braket Quantum Simulator with Grover's Algorithm
...
def main():
    ...
    output_file = script_dir / "decryption_metrics_braket_grover.txt"
    ...
    print(f"RC4 Cipher Attack using Amazon Braket with Grover's Algorithm")
    print(f"=" * 80)
    ...
    with open(output_file, 'w') as f:
        f.write("=" * 140 + "\n")
        f.write("RC4 CIPHER QUANTUM ATTACK METRICS - GROVER'S ALGORITHM (Amazon Braket)\n")
        f.write("=" * 140 + "\n\n")
        f.write("QUANTUM SIMULATOR: Amazon Braket LocalSimulator\n")
