...
Using IBM Qiskit Aer Quantum Simulator
...
def grovers_search_quantum(plaintext, ciphertext, key_length, actual_key):
    """
    Simplified Grover's algorithm demonstration for RC4 key search using Qiskit Aer.
...
def main():
    ...
    output_file = script_dir / "decryption_metrics_aer_grover.txt"
    ...
    print(f"Quantum-enhanced RC4 cipher attack using IBM Qiskit Aer (GROVER'S ALGORITHM)")
    print(f"=" * 80)
    ...
    with open(output_file, 'w') as f:
        f.write("=" * 140 + "\n")
        f.write("RC4 CIPHER QUANTUM ATTACK METRICS - GROVER'S ALGORITHM (IBM Qiskit Aer)\n")
        f.write("=" * 140 + "\n\n")
        f.write("QUANTUM SIMULATOR: IBM Qiskit Aer\n")
